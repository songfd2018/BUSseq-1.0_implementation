...
###################
# Working directory
setwd("/scratch/data01/BUSseq_cpp/Revision/GitHub_sub/NewHemat/Selecting_HEG/")

# Loading hemat count data
y_ori <- read.table(paste0("../../MouseHematopoieticPlus/RawCountData/count_data_",proj,"_v",ver_ori,".txt"))
y_cur <- read.table(paste0("RawCountData/count_data_",proj,"_v",ver_cur,".txt"))

# Load dimension
dim_ori <- read.table(paste0("../../MouseHematopoieticPlus/RawCountData/dim_",proj,"_v",ver_ori,".txt"))
...
# Load metadata
metadata <- read.table(paste0("../../MouseHematopoieticPlus/RawCountData/metadata_",proj,"_v",ver_ori,".txt"))

# Load gene_list
gene_list_ori <- unlist(read.table(paste0("../../MouseHematopoieticPlus/RawCountData/gene_list_",proj,"_v",ver_ori,".txt"),stringsAsFactors = F))
...
# load w_est
w_ori <- read.table(paste0("../../MouseHematopoieticPlus/Inference_K",K,"/w_est.txt"))
w_ori <- unlist(w_ori)
...
D_ori <- unlist(read.table(paste0("../../MouseHematopoieticPlus/Inference_K",K,"/IG_est.txt")))
