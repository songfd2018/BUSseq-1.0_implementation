...
jpeg("Image/BIC_values_v4.jpg",width = 540, height = 810)
...
jpeg("Image/heatmap_simulation_est_log_mean_expression_levels_v4.jpg",width = 1080, height = 1440)
...
jpeg("Image/heatmap_simulation_est_batch_effects_v4.jpg",width = 1080, height = 1440)
...
jpeg("Image/heatmap_simulation_log_imputed_count_v4.jpg",width = 1080, height = 1440)
...
jpeg("Image/heatmap_simulation_log_corrected_count_v4.jpg",width = 1080, height = 1440)
...
jpeg("./Image/scatter_simulation_cell_size_factors_v4.jpg",width = 540, height = 810)
...
BUSseq_by_celltype<- "Image/tsne_simulation_BUSseq_by_celltype_v4.jpg"
...
BUSseq_by_batch <- "Image/tsne_simulation_BUSseq_by_batch_v4.jpg"
dat_frame <- data.frame(Var1 = tsne_BUSseq_dist$Y[,1], 
                        Var2 = tsne_BUSseq_dist$Y[,2], 
                        col = batch_factor)
...
BUSseq_PCA<- "Image/pca_simulation_BUSseq_v4.jpg"
